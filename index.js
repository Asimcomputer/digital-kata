    ...
    let users = JSON.parse(localStorage.getItem('kataUsers')) || {
        'admin': { password: 'password', createdAt: new Date().toISOString() },
        'amjad': { password: 'amjad123', createdAt: new Date().toISOString() },
        'asim': { password: 'asim123', createdAt: new Date().toISOString() },
        'awais': { password: 'awais123', createdAt: new Date().toISOString() },
        'hamza': { password: 'hamza123', createdAt: new Date().toISOString() }
    };
